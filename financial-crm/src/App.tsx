...
import { Dashboard, RealOrders, RealOrderDetail, RealReceipts, RealReceiptDetail, AdminUsers, Financieras, ShippingForm, ShippingDocuments, ComprobantesForm, IntegrationSettings, TransportesRanking, QrDeposito, Deposito, DepositoEmpleados, DepositoStockIssues, DepositoErrores } from './pages';
      ...
      <Route path="*" element={
        <Layout>
          <Routes>
            ...
            <Route path="/deposito/stock-issues" element={<DepositoStockIssues />} />
            <Route path="/deposito/errores" element={<DepositoErrores />} />
            ...
            {/* Marketing */}
            <Route path="/marketing/stock" element={<StockAlerts />} />
            <Route path="/marketing/resenas" element={<MarketingReviews />} />
            {/* Redirect ruta vieja a la nueva para no romper bookmarks */}
            <Route path="/admin/stock-alerts" element={<Navigate to="/marketing/stock" replace />} />
